...
<body>
    <div class="main-wrapper">
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="form-group">
                                                <input id="txtUId" name="txtUId" value="<?php if (isset($_GET['id'])) {
                                                 ...
                                                 <?php
                                                $query_doctor = mysqli_query($cnn, "SELECT s.*,d.name AS department_name,s.department_id AS department_id FROM staff AS s
                                                    JOIN department AS d ON s.department_id = d.id WHERE s.email='" . $_SESSION['admin'] . "'");
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" value="<?php echo $row_doctor['department_name']; ?>" readonly>
                                                <input type="hidden" id="txtDep" name="txtDep" value="<?php echo $row_doctor['department_id']; ?>">
        ...
        <?php include("../admin/included_js.php"); ?>
            <script src="../newjs/leave_in.js"></script>
        <script>
