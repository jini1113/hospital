                ...
                <li class="nav-item dropdown has-arrow">
                    <a href="#" class="dropdown-toggle nav-link user-link" data-toggle="dropdown">
                        ...
                        <span class="user-icon rounded-circle">
                            ...
                            if ($row_cnt['image'] != NULL && $row_cnt['image'] != "") { ?>
                                ...
                                ?>
                                <img src="../admin/assets/img/user.jpg" alt="" style="height: 50px;" class="rounded-circle p-1" />
                    ...
                    <div class="dropdown-menu p-3">
                        ...
                        <a class="dropdown-item p-2 " style="font-size:16px;" href="profile.php"> <i
                            ...
                            Profile</a>
                        <a class="dropdown-item p-2" style="font-size:16px;" href="../changepwd.php"><i
        ...
        <div class="page-wrapper">
            <div class="content">
                <div class="row">
                    <div class="col-md-6 col-sm-6 col-lg-6 col-xl-3">
                        <div class="dash-widget">
                            <span class="dash-widget-bg1" style="background-color:#D8A25E;"><i class="fa fa-user-md"
                                    aria-hidden="true"></i></span>
                            <div class="dash-widget-info text-right">
                                <h3><?php
                                $query_doc = mysqli_query($cnn, "SELECT * from staff  where role='Doctor' AND status='Active'");
                                $count = mysqli_num_rows($query_doc);
                                echo "<span class='cont'>" . $count . "</span>";

                                ?></h3>
                                <span class="widget-title1" style="background-color:#D8A25E;">Doctors <i
                    ...
                    <div class="col-md-6 col-sm-6 col-lg-6 col-xl-3">
                        <div class="dash-widget">
                            ...
                            <div class="dash-widget-info text-right">
                                <h3>72</h3>
                                <span class="widget-title3">Employee <i class="fa fa-check"
                                        aria-hidden="true"></i></span>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 col-sm-6 col-lg-6 col-xl-3">
                        <div class="dash-widget">
                            <span class="dash-widget-bg2" style="background-color:#86AB89;"><i
                                    class="fa fa-wheelchair"></i></span>
                            <div class="dash-widget-info text-right">
                                <h3><?php
                                $query_doc = mysqli_query($cnn, "SELECT * from patients where  status='Active'");
                                $count = mysqli_num_rows($query_doc);
                                echo "<span class='cont'>" . $count . "</span>";

                                ?></h3>
                                <span class="widget-title2" style="background-color:#86AB89;">Patients <i
                                        class="fa fa-check" aria-hidden="true"></i></span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6 col-sm-6 col-lg-6 col-xl-3">
                        <div class="dash-widget">
                            <span class="dash-widget-bg4" style="background-color:#5B99C2;"><i class="fa fa-calendar"
                                    aria-hidden="true"></i></span>
                            <div class="dash-widget-info text-right">
                                <h3>618</h3>
                                <span class="widget-title4" style="background-color:#5B99C2;">Appointment <i
                                        class="fa fa-check" aria-hidden="true"></i></span>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-6 col-sm-6 col-lg-6 col-xl-3">
                        <div class="dash-widget">
                            <span class="dash-widget-bg1" style="background-color:#7FBDCA;"><i class="fa fa-medkit"
                                    aria-hidden="true"></i></span>
                            <div class="dash-widget-info text-right">
                                <h3><?php
                                $query_doc = mysqli_query($cnn, "SELECT * from staff  where role='Doctor' AND status='Active'");
                                ...
                                ?></h3>
                                <span class="widget-title1" style="background-color:#7FBDCA;">Available OPD <i
                                        class="fa fa-check" aria-hidden="true"></i></span>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 col-sm-6 col-lg-6 col-xl-3">
                        <div class="dash-widget">
                            <span class="dash-widget-bg2" style="background-color:#FF9874;"><i
                                    class="fa fa-bed"></i></span>
                            <div class="dash-widget-info text-right">
                                <h3><?php
                                $query_bed = mysqli_query($cnn, "SELECT * from bed where  status='Avaliable'");
                                $count = mysqli_num_rows($query_bed);
                                echo "<span class='cont'>" . $count . "</span>";

                                ?></h3>
                                <span class="widget-title2" style="background-color:#FF9874;">Available Bed <i
                                        class="fa fa-check" aria-hidden="true"></i></span>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 col-sm-6 col-lg-6 col-xl-3">
                        <div class="dash-widget">
                            <span class="dash-widget-bg3" style="background-color:#BB9AB1;"><i class="fa fa-user-md"
                                    aria-hidden="true"></i></span>
                            <div class="dash-widget-info text-right">
                                <h3>72</h3>
                                <span class="widget-title3" style="background-color:#BB9AB1;">Attend <i
                                        class="fa fa-check" aria-hidden="true"></i></span>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 col-sm-6 col-lg-6 col-xl-3">
                        <div class="dash-widget">
                            <span class="dash-widget-bg4" style="background-color:#D1BB9E;"><i class="fa fa-heartbeat"
                                    aria-hidden="true"></i></span>
                            <div class="dash-widget-info text-right">
                                <h3>618</h3>
                                <span class="widget-title4" style="background-color:#D1BB9E;">Pending <i
                                        class="fa fa-check" aria-hidden="true"></i></span>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <li>
                                        <div class="contact-cont">
                                            <div class="float-left user-img m-r-10">
                                                <a href="profile.html" title="John Doe"><img src="../admin/assets/img/user.jpg"
                                        ...
                                        <div class="contact-cont">
                                            <div class="float-left user-img m-r-10">
                                                <a href="profile.html" title="Richard Miles"><img
                                                        src="../admin/assets/img/user.jpg" alt=""
