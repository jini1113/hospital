            ...
            <div class="content">
                <div class="row">
                    ...
                    <div class="col-sm-8 col-9 text-right m-b-20">
                        <a href="add-edit-leave.php" class="btn btn btn-primary btn-rounded float-right"><i
                            ...
                            <table class="table table-striped custom-table  mb-0 m-auto text-center " id="tbl_app2">
                                ...
                                <tbody>
                                   ...
                                   while ($row = mysqli_fetch_array($query)) {
                                    ...
                                    if ($row['status'] == 'Pending') {
                                        echo "<td><button type='button' id='btnActive' name='btnActive' class='btn btn-warning active_block'  style='border-radius:4px;'>Pending</button></td>";
                                    } elseif ($row['status'] == 'Approved') {
                                        echo "<td><button type='button' id='btnBlock' name='btnBlock' class='btn btn-success block_active' style='border-radius:4px;'>Approve</button></td>";
                                    }else{
                                        echo "<td><button type='button' id='btnBlock' name='btnBlock' class='btn btn-danger block_active' style='border-radius:4px;'>Rejected</button></td>";
                                    }
