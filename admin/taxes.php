            ...
            <div class="content">
                <div class="row">
                    ...
                    <div class="col-sm-4 col-6 text-right m-b-30">
                        <a href="add-edit-tax.php" class="btn btn-primary btn-rounded"><i class="fa fa-plus"></i> Add
                            Tax</a>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12">
                        <div class="table-responsive">
                            <table class="table table-striped custom-table  mb-0 m-auto text-center " id="tbl_tax">
                                <thead>
                                    <tr>
                                        <th>No.</th>
                                        <th>Tax Name</th>
                                ...
                                <tbody>
                                    <?php
                                    $query = mysqli_query($cnn, "select * from tax");
                                    $cnt = 1;
