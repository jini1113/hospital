...
<body>
    <div class="main-wrapper">
            ...
            <div class="content">
                <div class="row">
                    <div class="col-lg-8 offset-lg-2">
                        <?php
                        if (isset($_GET['id'])) {
                            $query = mysqli_query($cnn, "select * from holidays where id=" . $_GET['id'] . "");
                            ...
                            <div class="col-lg-8 offset-lg-2">
                                <form method="post" enctype="multipart/form-data" id="frm">
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            <label>Date </label>
                                            <input type="date" class="form-control " name="txtDate" id="txtDate" value="<?php if (isset($_GET['id'])) {
                                                echo $row['date'];
                                            } ?>">
                                        </div>
                                    </div>
        ...
        <script src="../newjs/holiday.js"></script>
