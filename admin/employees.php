...
<body>
            ...
            <div class="content">
                <div class="row">
                    ...
                    <div class="col-sm-8 col-9 text-right m-b-20">
                        <a href="add-edit-employee.php" class="btn btn-primary float-right btn-rounded"><i
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="table-responsive">
                            <table class="table table-striped custom-table  mb-0 m-auto text-center " id="tbl_emp">
                                <thead>
                                    <tr>
                                        <th>No.</th>
                                        <th>Role</th>
                                ...
                                <tbody>
                                    <?php
                                    $query = mysqli_query($cnn, "select * from staff where role='Staff'");
                                    $cnt = 1;
                                    while ($row = mysqli_fetch_array($query)) {
                                        // $query_state = mysqli_query($cnn, "select * from tbl_states where id=" . $row['state_id'] . "");
                                        // $row_state = mysqli_fetch_array($query_state);
                                        // $query_city = mysqli_query($cnn, "select * from city where id=" . $row['city_id'] . "");
                                        ...
                                        //     </div>
                                        // </td>';
                                        echo "<td><a href='add-edit-employee.php?id=" . $row['id'] . "'><button type='button' id='btnEdit' name='btnEdit' title='Edit'  class='btn btn-link edit editDetail'>
    ...
    <script type="text/javascript" src="../newjs/employee.js"></script>
