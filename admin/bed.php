...
<body>
    <div class="main-wrapper">
            ...
            <div class="content">
                <div class="row">
                    <div class="col-sm-8 col-6">
                        <h4 class="page-title">Manage Bed</h4>
                    </div>
                    <div class="col-sm-4 col-6 text-right m-b-30">
                        <a href="add-edit-bed.php" class="btn btn-primary btn-rounded float-right"><i
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="table-responsive">
                            <table class="table table-striped custom-table  m`b-0 m-auto text-center " id="tbl_bed">
                                <thead>
                                    <tr>
                                        <th>No.</th>
                                        <th>Bed No.</th>
                                ...
                                <tbody>
                                    <?php
                                    $query = mysqli_query($cnn, "select * from bed");
                                    $cnt = 1;
        ...
        <script type="text/javascript" src="../newjs/bed.js"></script>
