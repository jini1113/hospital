...
<body>
    <div class="main-wrapper">
            ...
            <div class="content">
                <div class="row">
                    ...
                    <div class="col-sm-4 col-6 text-right m-b-30">
                        <a href="add-edit-asset.php" class="btn btn-primary btn-rounded float-right"><i
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="table-responsive">
                            <table class="table table-striped custom-table  mb-0 m-auto text-center " id="tbl_asset">
                                <thead>
                                    <tr>
                                        <th>No.</th>
                                        <th>Image</th>
                                ...
                                <tbody>
                                    <?php
                                    $query = mysqli_query($cnn, "select * from assets");
                                    $cnt = 1;
                                    while ($row = mysqli_fetch_array($query)) {
                                        ...
                                        echo "<tr>";
                                        echo "<td>" . $cnt . "</td>";
                                        echo "<td><img src='../image/" . $row['image'] . "'width='50%'/></td>";
                                        echo "<td>" . $row['name'] . "</td>";
                                        echo "<td>" . $row['serial_no'] . "</td>";
                                        echo "<td>" . $row['pur_date'] . "</td>";
                                        echo "<td>" . $row['pur_from'] . "</td>";
                                        echo "<td>" . $row['manufacture'] . "</td>";
                                        echo "<td>" . $row['model'] . "</td>";
                                        echo "<td>" . $row['supplier'] . "</td>";
                                        echo "<td>" . calculateWarrantyYears($row['warranty']) . "</td>";
                                        ...
                                        echo "<td><a href='add-edit-asset.php?id=" . $row['id'] . "'><button type='button' id='btnEdit' name='btnEdit' title='Edit'  class='btn btn-link'>
        ...
        <script type="text/javascript" src="../newjs/asset.js"></script>
        <script>
