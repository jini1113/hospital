...
<body>
    <div class="main-wrapper">
            ...
            <div class="content">
                <div class="row">
                    <div class="col-lg-8 offset-lg-2">
                        <?php
                        if (isset($_GET['id'])) {
                            $query = mysqli_query($cnn, "select * from ward where id=" . $_GET['id'] . "");
                    ...
                    <div class="card pt-5 pb-5 m-auto w-75 ">
                        <div class="row">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" type="number" id="txtCap" name="txtCap"
                                                    value="<?php if (isset($_GET['id'])) {
                                                        echo $row['capacity'];
                                                    } ?>">
                                            </div>
                            ...
                            if (isset($_POST['btnSubmit'])) {
                                ...
                                $cols = "name,capacity,status";
                                $values = "'$name','$capacity','Active'";
                                ...
                                $query = mysqli_query($cnn, "INSERT INTO ward ($cols) VALUES ($values)");

                                if ($query) {

                                    echo "<script>window.location.replace('ward.php');</script>";
                                } else {
                            ...
                            if (isset($_POST['btnUpdate'])) {
                                ...
                                $query = mysqli_query($cnn, "update ward set " . $cols . " where id=" . $id . "");
                                if ($query > 0) {
                                    echo "<script>window.location.replace('ward.php');</script>";
                                } else {
        ...
        <script type="text/javascript" src="../newjs/ward.js"></script>
</body>
