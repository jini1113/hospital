                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="table-responsive">
                            <table class="table table-striped custom-table  mb-0 m-auto text-center " id="tbl_issue">
                                <thead>
                                    <tr>
                                        <th>No.</th>
                                        <th>Issue Date</th>
                                ...
                                <tbody>
                                    <?php
                                    $query = mysqli_query($cnn, "select * from b_issue");
                                    $cnt = 1;
                                    while ($row = mysqli_fetch_array($query)) {
                                        ...
                                        $query_doc = mysqli_query($cnn, "select * from staff where id=" . $row['doctor_id'] . " AND role='Doctor' ");
                                        $row_doc = mysqli_fetch_array($query_doc);
                                        $query_donor = mysqli_query($cnn, "select * from donor where id=" . $row['donor_id'] . "");
                                        $row_donor = mysqli_fetch_array($query_donor);
