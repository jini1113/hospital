            ...
            <div class="content">
                <div class="row">
                    ...
                    <div class="col-sm-7 col-7 text-right m-b-30">
                        <a href="add-edit-ward.php" class="btn btn-primary btn-rounded"><i class="fa fa-plus"></i> Add
                            Ward</a>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12">
                        <div class="table-responsive">
                            <table class="table table-striped custom-table  mb-0 m-auto text-center " id="tbl_ward">
                                ...
                                <tbody>
                                    <?php
                                    $query = mysqli_query($cnn, "select *  from ward");
                                    $cnt = 1;
                                    while ($row = mysqli_fetch_array($query)) {

                                        echo "<tr>";
                                        echo "<td>" . $cnt . "</td>";
                                        echo "<td><img src='../image/" . $row['image'] . "' width='120px' height='60px'/></td>";
