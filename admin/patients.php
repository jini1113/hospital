...
<body>
            ...
            <div class="content">
                <div class="row">
                    ...
                    <div class="col-sm-8 col-9 text-right m-b-20">
                        <a href="add-edit-patient.php" class="btn btn btn-primary btn-rounded float-right"><i
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="table-responsive">
                            <table class="table table-striped custom-table  mb-0 m-auto text-center " id="tbl_patients">
                                <thead>
                                    <tr>
                                        <th>No.</th>
                                        <th>Name</th>
                                ...
                                <tbody>
                                    <?php
                                    $query = mysqli_query($cnn, "select * from patients");
                                    $cnt = 1;
                                    while ($row = mysqli_fetch_array($query)) {
                                        ...
                                        //     </div>
                                        // </td>';
                                        echo "<td><a href='add-edit-patient.php?id=" . $row['id'] . "'><button type='button' id='btnEdit' name='btnEdit' title='Edit'  class='btn btn-link'>
    ...
    <script type="text/javascript" src="../newjs/patients.js"></script>
