...
<body>
            ...
            <div class="content">
                <div class="row">
                    <div class="col-sm-5 col-5">
                        <h4 class="page-title">Department of Employees</h4>
                    </div>
                    <div class="col-sm-7 col-7 text-right m-b-30">
                        <a href="add-edit-department.php" class="btn btn-primary btn-rounded"><i class="fa fa-plus"></i> Add
                            Department</a>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12">
                        <div class="table-responsive">
                            <table class="table table-striped custom-table  mb-0 m-auto text-center " id="tbl_department">
                                <thead>
                                    <tr>
                                        <th>No.</th>
                                ...
                                <tbody>
                                    <?php
                                    $query = mysqli_query($cnn, "select id,name,status from department");
                                    $cnt = 1;
                                    while ($row = mysqli_fetch_array($query)) {
                                        ...
                                        //     </div>
                                        // </td>';
                                        echo "<td><a href='add-edit-department.php?id=" . $row['id'] . "'><button type='button' id='btnEdit' name='btnEdit' title='Edit'  class='btn btn-link'>
    ...
    <script type="text/javascript" src="../newjs/department.js"></script>
