                        ...
                        <div class="row">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control " type="date" name="txtJob" id="txtJob"
                                                    value="<?php if (isset($_GET['id'])) {
                                                        echo $row['job'];
                                                    } ?>">
                            ...
                            if (isset($_POST['btnSubmit'])) {
                                ...
                                if ($row_user[0] > 0) {
                                    ...
                                    $values = "'Staff','$department','$name', '$email', '$enc_pass', '$phone', '$dob', '$job','$add', '$state', '$gen', 'Active'";
                            ...
                            if (isset($_POST['btnUpdate'])) {
                                ...
                                if ($query > 0) {
                                    echo "<script>window.location.replace('employees.php');</script>";
                                } else {
